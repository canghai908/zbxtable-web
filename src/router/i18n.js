  ...
  messages: {
    CN: {
      ...
      alarm: {
        ...
        alarmRule: {name: '分发规则'},
        mutes: {name: '屏蔽规则'},
        alarmMutes: {name: '屏蔽规则'},
        analysis: {name: '告警分析'},
        alarmAnalysis: {name: '告警分析'}
      },
      host: {
        name: '主机应用',
        linux: {name: 'Linux'},
      ...
      system: {
        name: '系统管理',
        users: {name: '用户管理'},
        systemUsers: {name: '用户管理'},
        groups: {name: '用户组'},
        systemGroups: {name: '用户组'},
        bandwidth: {name: '出口配置'},
        systemBandwidth: {name: '出口配置'},
        zabbix: {name: 'Zabbix 管理'},
        chpwd: {name: '密码修改'},
        systemChpwd: {name: '密码修改'},
        config: {name: '参数配置'},
        sysConfig: {name: '参数配置'},
        version: {name: '版本信息'},
        mapping: {name: '指标映射'},
    ...
    US: {
      ...
      form: {
        ...
        step: {name: 'Step Form'},
        advance: {name: 'Advanced Form'}
      },
      list: {
        name: 'List',
        query: {name: 'Query Table'},
        primary: {name: 'Standard List'},
        card: {name: 'Card List'},
        search: {
          name: 'Search List',
      ...
      details: {
        name: 'Details',
        basic: {name: 'Basic Details'},
        advance: {name: 'Advanced Details'}
      },
      result: {
        name: 'Result',
      ...
      components: {
        name: 'Components',
        taskCard: {name: 'Task Card'},
        palette: {name: 'Color Checkbox'}
      }
    },
    HK: {
      home: {name: '首頁'},
      ...
      system: {
        name: '系統管理',
        users: {name: '用戶管理'},
        systemUsers: {name: '用戶管理'},
        groups: {name: '用戶組'},
        systemGroups: {name: '用戶組'},
        bandwidth: {name: '出口配置'},
        systemBandwidth: {name: '出口配置'},
        zabbix: {name: 'Zabbix 管理'},
        chpwd: {name: '密碼修改'},
        systemChpwd: {name: '密碼修改'},
        config: {name: '參數配置'},
        sysConfig: {name: '參數配置'},
        version: {name: '版本信息'},
        mapping: {name: '指標映射'},
