              ...
              <a-col :xl="{ span: 24 }" :lg="{ span: 24 }">
                <a-col :xl="{ span: 24 }" :lg="{ span: 24 }">
                  ...
                  <a-table :loading="loading2" :columns="columns2" :data-source="Interfacelist" :pagination=false :scroll="{ y: 300, }" :rowKey="(record) => { return record.id;}">
                    ...
                    <div slot="speed" slot-scope="record">{{record.speed}}</div>
...
import { hostDetail, hostMock, hostMockd, linMonList } from "@/services/admin";
...
export default {
  ...
  filters: {
    ...
    //     console.log(zbx)
    //     if (value == "6") {
    //       this.operational_status = "1"; // up 
    //     } else if (value == "2") {
    //       this.operational_status = "2"; // down
    //     } else if (value == "3") {
    //       this.operational_status = "3"; // testing
    //     }
    //   } else {
    //     if (value == "1") {
    //       this.operational_status = "1"; // up
    ...
    //       this.operational_status = "2"; // down
    //     } else if (value == "3") {
    //       this.operational_status = "3"; // unknown 
    //     }
    //   }
    // },
  },
  methods: {
    init() {
      ...
      // zbxVersion().then((resp) => {
      //   let res = resp.data;
      //   this.zbx = res.data.items
